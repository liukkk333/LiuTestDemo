...
Pod::Spec.new do |s|
  s.name             = 'LiuCategoryt'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LiuCategoryt.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/liukkk333/LiuCategoryt'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'liukkk333' => 'liuk@izkml.com' }
  s.source           = { :git => 'https://github.com/liukkk333/LiuCategoryt.git', :tag => s.version.to_s }
